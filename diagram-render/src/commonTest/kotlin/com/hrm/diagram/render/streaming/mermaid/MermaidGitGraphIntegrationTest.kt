...
class MermaidGitGraphIntegrationTest {
    @Test
    fun gitgraph_renders_and_is_streaming_consistent() {
        val src =
            """
            gitGraph
              commit id: "A"
        ...
        val oneIr = assertIs<GitGraphIR>(one.ir)
        val chunkedIr = assertIs<GitGraphIR>(chunked.ir)
